    ...
    <div>
        ...
        <RouterLink :to="{ name: 'users' }">
            <div class="text-3xl font-nabla hidden md:block">
                ...
                <span class="logo-char animation-delay-600">a</span>
                <span class="logo-char animation-delay-700">n</span>
                <span class="logo-char animation-delay-800">h</span>
                <span class="logo-char animation-delay-900">a</span>
<span class="">{{ ' ' }}</span>
                <span class="logo-char animation-delay-1000">s</span>
                <span class="logo-char animation-delay-1100">h</span>
                <span class="logo-char animation-delay-1200">o</span>
                <span class="logo-char animation-delay-1300">p</span>
